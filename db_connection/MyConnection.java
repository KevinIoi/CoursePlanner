...
public class MyConnection {
	...
	/**
	 * Issues a custom UPDATE command to the mysql DB. This must be a mutator command (INSERT, DROP, UPDATE...)
	 *
	...
	/**
	 * Issues a custom EXECUTE command to the mysql DB. This must be an accessor command (SELECT .. )
